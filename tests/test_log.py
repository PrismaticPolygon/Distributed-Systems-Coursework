...
class StableTest(unittest.TestCase):
    def setUp(self):
        self.r1 = Record("1", Timestamp({"1": 1, "2": 0, "3": 0}), ClientRequest(Operation.READ, {}), Timestamp(),
                         "id_1")
        self.r2 = Record("2", Timestamp({"1": 0, "2": 0, "3": 0}), ClientRequest(Operation.READ, {}), Timestamp(),
                         "id_2")
        self.r3 = Record("3", Timestamp({"1": 0, "2": 0, "3": 1}), ClientRequest(Operation.READ, {}), Timestamp(),
                         "id_3")
